...
export const BASE_PATH = 'https://sandbox.iexapis.com/stable';
export const ENDPOINT_PATH = '/stock/AAPL/financials/12';
export const QUERY_PARAM = 'token=';
export const API_KEY = 'Tpk_d232dd87ed34407dacc92eee1edbf407';
